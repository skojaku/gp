 ...
 * `edges` - Mx3 Numpy array (should be float array), where M is the number of edges. The first and second columns indicate the IDs of nodes connected by an edge, which starts from 1. The third column indicates the weight of the edge. 
